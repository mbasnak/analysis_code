...
for folder = 1:length(foldernames)
    if contains(foldernames(folder).name,'60D05')
        ...
        %save figure
        saveas(gcf,[path,'\plots\offset_var.png'])
        ...
        save([path,'\offset_var_data.mat'],'offset_var_bar','offset_var_wind','offset_var_empty')
        save([path,'\offset_precision_data.mat'],'offset_precision_bar','offset_precision_wind','offset_precision_empty','bump_mag_bar','bump_mag_wind','bump_mag_empty','bump_width_bar','bump_width_wind','bump_width_empty')
